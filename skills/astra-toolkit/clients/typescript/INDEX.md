# TypeScript examples index

339 snippets in [examples/](examples/). Each file is `examples/<category>-<operation>[-<variant>].ts`;
...
- `collections-find-distinct`: array, basic, nested, subset
...
- `tables-projection-exclude`: cursor
- `tables-projection-include`: all, cursor
- `tables-update`: set
