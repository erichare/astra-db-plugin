...
339 snippets in [examples/](examples/). Each file is `examples/<category>-<operation>[-<variant>].cs`;
...
- `client-database`
- `client-get`: astra-admin, db-admin-from-db
- `client-no-options`
- `client-options`
- `client-token`
...
- `tables-projection-exclude`: many
- `tables-projection-include`: all, many
- `tables-typing`
- `tables-update`: set
...
- `vectorize-`
- `vectorize-alter-table-add`: typed, untyped
- `vectorize-alter-table-enable`: typed, untyped
