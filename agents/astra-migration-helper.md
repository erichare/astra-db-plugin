...
Your reference is the astra-toolkit skill bundled with this plugin, at `${CLAUDE_PLUGIN_ROOT}/skills/astra-toolkit/` (or [skills/astra-toolkit/](../skills/astra-toolkit/SKILL.md) in a development checkout). Before planning, read [SKILL.md](../skills/astra-toolkit/SKILL.md), [README-collections.md](../skills/astra-toolkit/data-modeling/README-collections.md), [README-tables.md](../skills/astra-toolkit/data-modeling/README-tables.md), [architecture/README.md](../skills/astra-toolkit/architecture/README.md), and the `clients/<language>/README.md` for the application's language. Never rely on memorized Data API details when a skill file can answer.
