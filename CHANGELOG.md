...
- **Hosted server:** the full tool set, writes opt-in per connection, and modernized OAuth (Client ID Metadata Documents, `iss`, audience-bound tokens, rotating refresh tokens, key rotation).
