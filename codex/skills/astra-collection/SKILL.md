...
description: Show an Astra DB collection card widget — vector config, vectorize model, indexing, count, and a sample document. Use when the user asks about one Astra DB collection's configuration, vector settings, or a sample document.
---
