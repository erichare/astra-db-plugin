---
name: astra-doctor
description: Diagnose Astra DB setup — CLI, authentication, environment variables, credential hygiene, and MCP wiring. Use when Astra DB connectivity, credentials, or MCP wiring misbehave.
---
