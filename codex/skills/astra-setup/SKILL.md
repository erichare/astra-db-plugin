---
name: astra-setup
description: Set up Astra DB for this project — Astra CLI, application token, and .env connection settings. Use when the user wants to connect a project to Astra DB or install the Astra CLI.
---
