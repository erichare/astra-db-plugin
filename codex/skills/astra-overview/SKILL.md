---
name: astra-overview
description: "Show an Astra DB database overview widget — keyspaces, collections (vector config, counts), and tables. Use when the user wants to see what is in an Astra DB database: keyspaces, collections, tables, counts."
---
