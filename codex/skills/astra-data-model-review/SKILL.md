---
name: astra-data-model-review
description: Review this project's Astra DB data model against Collections/Tables best practices and anti-patterns. Use when the user asks to review or audit an Astra DB data model or Data API usage.
---

Review the current project's Astra DB data model and Data API usage. Use the $astra-data-modeler skill for the design assessment and, if data-access code exists, the $astra-reviewer skill for usage review — run them in parallel when both apply.

## Reference material

Ground every finding in the skill content bundled with this plugin:

- [data-modeling/README-collections.md](../astra-toolkit/data-modeling/README-collections.md) — Collections modeling tips and anti-patterns
- [data-modeling/README-tables.md](../astra-toolkit/data-modeling/README-tables.md) — Tables modeling tips and anti-patterns
- [architecture/README.md](../astra-toolkit/architecture/README.md) — application architecture patterns
- `clients/<language>/README.md` in the same skill — language-specific idioms and limitations

When installed as a plugin, these files live under `${PLUGIN_ROOT}/skills/astra-toolkit/`.
